...
-   [uizze/anti-ui-slop](https://github.com/uizze/uizze/tree/main/skills/anti-ui-slop)：面向 Codex、Claude Code、Cursor、Copilot 等编码代理的 UI 质量技能；在改 UI 前建立产品化设计契约、检查必要状态，并通过渲染复核拦截通用 AI 界面。可免费安装 `npx skills add https://uizze.com --skill anti-ui-slop`；完整 UIZZE 另提供基于 800,000+ 个真实 Web 和 iOS 界面的检索与审查能力
